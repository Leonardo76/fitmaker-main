import { DateChooserProps } from "../lib/types";
import DateChooserCalendar from "./DateChooserCalendar";
import DateChooserInputs from "./DateChooserInputs";
import { useDateChooser } from "../hooks/useDateChooser";
...
export default function DateChooser({
  ...
  const {
    ...
    toggleCalendar,
    closeCalendar,
  } = useDateChooser({ minYear, maxYear, dateFormat, useCalendar });

  return (
    <div className={`relative ${classNameContainer ?? ""}`}>
      <DateChooserInputs
        dateFormat={dateFormatResolved}
        ...
        minYear={minYear}
        maxYear={maxYear}
        classNameDay={classNameDay}
        classNameMonth={classNameMonth}
        classNameYear={classNameYear}
